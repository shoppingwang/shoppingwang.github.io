...
### [我的博客在这里 &rarr;](http://shoppingwang.github.io)
...
```
# Site settings
title: XP Blog             # 你的博客网站标题
SEOTitle: XP Blog			# 在后面会详细谈到
description: "Cool Blog"    # 随便说点，描述一下

# SNS settings      
github_username: shoppingwang     # 你的github账号
weibo_username: shoppingwang      # 你的微博账号，底部链接会自动更新的。
...
sidebar-avatar: /img/avatar-XP.jpg     #你的大头贴，请使用绝对地址.
```
...
ga_domain: mllearn.com			# 默认的是 auto, 这里我是自定义了的域名，你如果没有自己的域名，需要改成auto。
```
...
标题底图是可以自己选的，看看几篇示例post你就知道如何设置了。在
  [issue #6 ](https://github.com/shoppingwang/shoppingwang.github.io/issues/6) 中我被问到：怎么样才能让标题底图好看呢？
...
我的博客标题是 **“XP Blog”** 但是我想要在搜索的时候显示 **“小平的博客 | XP Blog”** ，这个就需要SEO Title来定义了。
