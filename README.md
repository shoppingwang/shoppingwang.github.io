...
###[View Live XP Blog &rarr;](http://shoppingwang.github.io)
...
```
# Site settings
title: XP Blog             # title of your website
SEOTitle: XP Blog			# check out docs for more detail
description: "Cool Blog"    # ...

# SNS settings      
github_username: shoppingwang     # modify this account to yours
weibo_username: shoppingwang      # the footer woule be auto-updated.
...
sidebar-avatar: /img/avatar-XP.jpg     # use absolute URL.
```
...
---
layout:     keynote
iframe:     "http://mllearn.com/js-module-7day/"
---
```
...
Change header images of any pages or any posts is pretty easy as mentioned above. But, thanks to [issue #6 (in Chinese)](https://github.com/shoppingwang/shoppingwang.github.io/issues/6) asked, **how to make it looks great?**
...
It's possible that you want the two things different. For me, my site-title is **“XP Blog”** but I want the title shows in search engine is **“小平的博客 | XP Blog”** which is multi-language.
